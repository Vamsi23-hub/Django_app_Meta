...
Open the file base.html and search for a comment: <!--Footer content--> On the line below, add a DTL tag that will include the relative path of the footer.html file.
